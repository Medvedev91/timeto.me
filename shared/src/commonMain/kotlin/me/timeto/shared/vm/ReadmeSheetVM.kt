...
private fun prepParagraphs(): List<ReadmeSheetVM.Paragraph> {
    ...
    paragraphs.add(PTextHighlight("The most important, when I press it, it automatically starts a timer."))
    paragraphs.add(PText("So you don't have to choose activity and timer. It starts automatically!"))
