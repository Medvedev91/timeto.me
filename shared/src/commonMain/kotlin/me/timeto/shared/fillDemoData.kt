...
suspend fun fillDemoData(
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day1Time + h8_30)
    IntervalDb.insertWithValidation(workActivityDb, null, day1Time + h9)
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day1Time + h17)
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day1Time + h17_30)
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day1Time + h18)
    IntervalDb.insertWithValidation(workoutActivityDb, null, day1Time + h19)
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day2Time + h8_30 + rand(15))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day2Time + h19 + rand(10))
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day2Time + h19_30 + rand(10))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day3Time + h8_30 + rand(15))
    IntervalDb.insertWithValidation(workActivityDb, null, day3Time + h9 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day3Time + h17 + rand(10))
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day3Time + h17_30 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day3Time + h18 + rand(10))
    IntervalDb.insertWithValidation(workoutActivityDb, null, day3Time + h19 + rand(10))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day4Time + h13_30 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day4Time + h14 + rand(10))
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day4Time + h18 + rand(10))
    ...
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day5Time + h13 + rand(10))
    IntervalDb.insertWithValidation(readingActivityDb, null, day5Time + h14 + rand(10))
    IntervalDb.insertWithValidation(workoutActivityDb, null, day5Time + h16 + rand(10))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day6Time + h8_30 + rand(15))
    IntervalDb.insertWithValidation(workActivityDb, null, day6Time + h9 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day6Time + h17 + rand(10))
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day6Time + h17_30 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day6Time + h18 + rand(10))
    IntervalDb.insertWithValidation(workoutActivityDb, null, day6Time + h19 + rand(10))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day7Time + h8_30 + rand(15))
    IntervalDb.insertWithValidation(workActivityDb, null, day7Time + h9 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day7Time + h17 + rand(10))
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day7Time + h17_30 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day7Time + h18 + rand(10))
    IntervalDb.insertWithValidation(workoutActivityDb, null, day7Time + h19 + rand(10))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day8Time + h8_30)
    IntervalDb.insertWithValidation(workActivityDb, null, day8Time + h9)
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day8Time + h17)
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day8Time + h17_30)
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day8Time + h18)
    IntervalDb.insertWithValidation(workoutActivityDb, null, day8Time + h19)
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day9Time + h8_30 + rand(15))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day9Time + h19 + rand(10))
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day9Time + h19_30 + rand(10))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day10Time + h8_30 + rand(15))
    IntervalDb.insertWithValidation(workActivityDb, null, day10Time + h9 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day10Time + h17 + rand(10))
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day10Time + h17_30 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day10Time + h18 + rand(10))
    IntervalDb.insertWithValidation(workoutActivityDb, null, day10Time + h19 + rand(10))
    ...
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day11Time + h13_30 + rand(10))
    IntervalDb.insertWithValidation(freeTimeActivityDb, null, day11Time + h14 + rand(10))
    IntervalDb.insertWithValidation(smallTasksActivityDb, null, day11Time + h18 + rand(10))
