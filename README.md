...
Most of the time my screen looks like a typical pomodoro timer:
...
Try to start a new activity. Back to the home screen, tap the timer at the bottom left, "Work", and start the timer.
