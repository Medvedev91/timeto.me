...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Removes all system paddings. Needs android:windowSoftInputMode="adjustNothing" on manifest.
...
fun ListenNewIntervalForTriggers() {
    ...
    LaunchedEffect(lastIntervalLive?.id) {
        ...
        val stringToCheckTriggers = lastInterval.note ?: lastInterval.getActivity().name
